const PrivacyPolicy = () => (
    <div>
        <p>
            ...
            is collected and recorded by The Green Plus and how we use it.
        </p>
        <p>
        ...
        <p>
            ...
            our website with regards to the information that they shared and/or collect in The Green
            Plus. This policy is not applicable to any information collected offline or via channels
        ...
        <h5>Log Files</h5>
        <p>
            The Green Plus follows a standard procedure of using log files. These files log visitors
        ...
        <p>
            ...
            Green Plus, which are sent directly to users&#39; browser. They automatically receive
        ...
        <p>
            Note that The Green Plus has no access to or control over these cookies that are used by
            third-party advertisers.
        </p>
        <h5>Third Party Privacy Policies</h5>
        <p>
            The Green Plus&#39;s Privacy Policy does not apply to other advertisers or websites.
        ...
        <p>
            The Green Plus does not knowingly collect any Personal Identifiable Information from
